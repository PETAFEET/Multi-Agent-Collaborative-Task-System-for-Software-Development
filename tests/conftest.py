...
from multi_agent.db.dependencies import get_db_session
from multi_agent.db.utils import create_database, drop_database
from multi_agent.services.rabbit.dependencies import get_rmq_channel_pool
from multi_agent.services.rabbit.lifespan import init_rabbit, shutdown_rabbit
from multi_agent.services.redis.dependency import get_redis_pool
from multi_agent.settings import settings
from multi_agent.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    from multi_agent.db.models import load_all_models
